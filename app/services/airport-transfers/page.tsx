...
import { 
  Plane, Clock, Shield, Star, Users, Briefcase, ChevronDown, 
  ArrowLeft, Check, MapPin, ChevronRight, Phone, Mail, Car, Anchor, Sparkles
} from 'lucide-react';
...
const AIRPORT_ROUTES = [
  ...
  { from: 'Southampton City Centre', to: 'London Gatwick Airport (LGW)', fromId: 'sou-cent', toId: 'lgw', price: '£135', time: '1h 40m' },
  ...
  { from: 'Southampton City Centre', to: 'London Stansted Airport (STN)', fromId: 'sou-cent', toId: 'stn', price: '£185', time: '2h 10m' },
];
...
const RECOMMENDED_VEHICLES = [
  {
    ...
    luggage: 2,
    priceFrom: '£55',
    features: ['Air Conditioning', 'Free 4G WiFi', 'USB Chargers']
  },
  {
    name: 'Estate Car',
    ...
    luggage: 4,
    priceFrom: '£68',
    features: ['Extra Boot Capacity', 'Dual Climate Control', 'Tinted Windows']
  },
  {
    ...
    luggage: 8,
    priceFrom: '£110',
    features: ['Conference Seating', 'Massive Luggage Hold', 'Individual AC Outlets']
  }
];
...
const AIRPORT_FAQS = [
  {
    ...
    a: 'We monitor your arrival in real-time. When you book, you provide your flight number. Our automated tracking systems check flight progress. If your flight is early, on-time, or delayed, we adjust your driver\'s dispatch automatically so they are waiting at the correct time.'
  },
  {
    q: 'Where do I meet my driver in the arrivals hall?',
    a: 'For our standard meet & greet service, your driver will be waiting in the terminal arrivals hall, just past the baggage reclaim exit. They will hold a digital iPad or print sign displaying your name. You will also receive an SMS with their phone number and vehicle details.'
  },
  {
    q: 'What is included in the price?',
    a: 'All quoted prices are completely fixed and fully inclusive of: 60 minutes free waiting time post-landing, full flight tracking, standard meet & greet terminal service, and all airport drop-off/pick-up toll gate charges.'
  },
  {
    q: 'Is there an extra charge if my flight is delayed?',
    a: 'No! There are absolutely no surcharges or extra fees if your flight is delayed. Your fixed rate remains identical, and we handle the schedule shift seamlessly.'
  }
];
...
export default function AirportTransfers() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-100 font-sans antialiased flex flex-col">
      ...
      <div className="bg-[#121215] border-b border-zinc-800 py-2 px-4 text-xs font-medium text-zinc-300">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-zinc-400">Fixed-price airport transfers with professional flight-tracking.</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-500/10 border border-amber-500/20 rounded-full text-gold text-xs font-semibold">
              ...
              <span>Premium Airport Taxis & Shuttles</span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight font-display text-white leading-tight">
              Stress-Free <span className="text-gold">Airport Transfers</span> Across the UK
            </h1>
            <p className="text-zinc-400 text-sm leading-relaxed max-w-xl">
              Professional, fixed-rate taxi journeys to and from London Heathrow (LHR), Gatwick (LGW), Stansted (STN), Luton (LTN), and Southampton (SOU). Features free meet & greet, automated flight delay monitoring, and a fully vetted executive fleet.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-6 border-t border-zinc-800/60">
              <div className="space-y-1">
                <span className="block text-white font-bold text-sm">60 Mins</span>
                <span className="block text-zinc-500 text-[10px] uppercase font-semibold">Free waiting time</span>
              </div>
              <div className="space-y-1">
                <span className="block text-white font-bold text-sm">No Surge</span>
                <span className="block text-zinc-500 text-[10px] uppercase font-semibold">Fixed guaranteed rate</span>
              </div>
              <div className="space-y-1">
                <span className="block text-white font-bold text-sm">Real-time</span>
                <span className="block text-zinc-500 text-[10px] uppercase font-semibold">Flight delay tracking</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#121215] rounded-3xl border border-zinc-800 shadow-xl overflow-hidden flex flex-col">
            <div className="h-48 relative w-full">
              <img 
                ...
                alt="Airport Chauffeur Transfer" 
            ...
            <h3 className="text-lg font-bold text-white font-display border-b border-zinc-800 pb-3">Why Passengers Choose Us</h3>
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-zinc-200 text-sm">Absolute Punctuality</h4>
                  <p className="text-zinc-400 text-xs mt-1 leading-relaxed">
                    Drivers arrive 10 minutes prior to scheduled pickup to allow calm loading. Backed by real-time dispatch systems.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-zinc-200 text-sm">Vetted & Licensed</h4>
                  <p className="text-zinc-400 text-xs mt-1 leading-relaxed">
                    Every driver is background DBS-checked, licensed by local government authorities, and drives a pristine clean vehicle.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-zinc-200 text-sm">Flight Connection Guarantee</h4>
                  <p className="text-zinc-400 text-xs mt-1 leading-relaxed">
                    If your flight gets shifted or postponed, we update our rosters automatically. Zero cancellation charges if you cancel 24 hours prior.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-[#09090b]" id="popular-routes">
        <div className="max-w-7xl mx-auto px-4 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-gold font-bold text-xs uppercase tracking-wider">Fast Direct Rates</span>
            <h2 className="text-3xl font-extrabold tracking-tight font-display text-white">
              Popular Airport Transfer Rates
            </h2>
              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-zinc-500 font-bold font-mono uppercase">Start Location</span>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-zinc-500 font-bold font-mono uppercase">Airport Terminal</span>
                  </div>
      ...
      {/* Recommended Airport Vehicles */}
      <section className="py-20 bg-[#121215]/40 border-y border-zinc-800/50">
        <div className="max-w-7xl mx-auto px-4 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-gold font-bold text-xs uppercase tracking-wider">Luggage Capacity Match</span>
            <h2 className="text-3xl font-extrabold tracking-tight font-display text-white">
              Airport Optimized Vehicles
            </h2>
            <p className="text-sm text-zinc-400 leading-relaxed">
              We recommend matching your passenger and suitcase load to the vehicle specs to guarantee a safe, comfortable airport ride.
            </p>
          </div>
              ...
              <div key={i} className="bg-[#121215] border border-zinc-800 rounded-3xl p-6 flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="text-[10px] bg-amber-500/10 text-gold px-2 py-0.5 rounded-md font-mono border border-amber-500/20">AIRPORT CHOSEN</span>
                  </div>
      ...
      <section className="py-20 bg-[#09090b]">
        <div className="max-w-3xl mx-auto px-4 space-y-12">
          <div className="text-center space-y-2">
            <span className="text-gold font-bold text-xs uppercase tracking-wider">Help Desk</span>
            <h2 className="text-3xl font-extrabold tracking-tight font-display text-white">
              Airport Transfer FAQs
            </h2>
            <p className="text-sm text-zinc-400 leading-relaxed">
              Essential questions to ensure a smooth, worry-free connection on your upcoming flight.
            </p>
          </div>

          <div className="space-y-4">
            {AIRPORT_FAQS.map((faq, i) => (
          ...
          <div className="bg-[#121215] p-6 rounded-3xl border border-zinc-800 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="space-y-1 text-center md:text-left">
              <h4 className="font-bold text-white text-sm">Need a direct quote for a custom address?</h4>
              <p className="text-xs text-zinc-500">Contact our 24/7 UK booking hotline for immediate pricing support.</p>
            </div>
            <a 
              href="tel:+442380000000"
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="text-xs space-y-2">
              <li><span className="text-gold">Airport Transfers</span></li>
          ...
          <div className="space-y-3">
            <h4 className="font-bold text-sm text-white">Popular Airport Gates</h4>
            <ul className="text-xs space-y-2">
              <li><Link href="/" className="hover:text-gold transition">London Heathrow (LHR)</Link></li>
              <li><Link href="/" className="hover:text-gold transition">London Gatwick (LGW)</Link></li>
              <li><Link href="/" className="hover:text-gold transition">London Stansted (STN)</Link></li>
              <li><Link href="/" className="hover:text-gold transition">Southampton Airport (SOU)</Link></li>
            </ul>
          </div>
